# N8n Workflows for AP Intake Project

This document contains all the n8n workflow JSON files that can be imported directly into n8n for the AP Intake project.

## How to Import

1. Copy the JSON content for each workflow
2. In n8n, go to Workflows → Import from File
3. Paste the JSON and import
4. Configure credentials and webhook URLs as needed

---

## 1. AP Invoice Processing Workflow
...
## 3. Weekly Report Generation Workflow
