...
# Test files
TEST_INVOICE_FILES = [
    "os.path.join(PROJECT_ROOT, "test_invoices/test_invoice_complex_20251107_175127.pdf")",
    "os.path.join(PROJECT_ROOT, "test_invoices/test_invoice_error_scenarios_20251107_175127.pdf")",
    "os.path.join(PROJECT_ROOT, "test_invoices/test_invoice_minimal_20251107_175127.pdf")"
]
