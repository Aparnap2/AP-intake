...
class InvoiceProcessor:
    ...
    def _init_checkpointer(self):
        ...
        try:
            ...
            import os
            os.makedirs(os.path.dirname(settings.LANGGRAPH_PERSIST_PATH), exist_ok=True)
            return SqliteSaver.from_conn_string(f"{settings.LANGGRAPH_PERSIST_PATH}/checkpoints.db")
